...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accessControlAllowDesc": MessageLookupByLibrary.simpleMessage(
      "선택한 앱만 VPN에 접속하도록 허용",
    ),
    "accessControlDesc": MessageLookupByLibrary.simpleMessage(
      "응용 프로그램 접근 프록시 설정",
    ),
    "accessControlNotAllowDesc": MessageLookupByLibrary.simpleMessage(
      "선택한 응용 프로그램은 VPN에서 제외됩니다",
    ),
    ...
    "application": MessageLookupByLibrary.simpleMessage("응용 프로그램"),
    ...
    "autoLaunch": MessageLookupByLibrary.simpleMessage("자동 실행"),
    ...
    "backupAndRecoveryDesc": MessageLookupByLibrary.simpleMessage(
      "WebDAV 또는 파일을 통해 데이터 동기화",
    ),
    "backupSuccess": MessageLookupByLibrary.simpleMessage("백업 성공"),
    "bind": MessageLookupByLibrary.simpleMessage("바인드"),
    ...
    "compatibleDesc": MessageLookupByLibrary.simpleMessage(
      "켜면 일부 응용 프로그램 기능을 잃고 Clash의 전체 지원을 받습니다.",
    ),
    ...
    "desc": MessageLookupByLibrary.simpleMessage(
      "ClashMeta를 기반으로 한 멀티 플랫폼 프록시 클라이언트, 간단하고 사용하기 쉬우며 오픈 소스이고 광고가 없습니다.",
    ),
    "detectionTip": MessageLookupByLibrary.simpleMessage(
      "타사 API에 의존하며 참고용으로만 제공됩니다",
    ),
    "direct": MessageLookupByLibrary.simpleMessage("직접"),
    "disclaimer": MessageLookupByLibrary.simpleMessage("면책 조항"),
    "disclaimerDesc": MessageLookupByLibrary.simpleMessage(
      "이 소프트웨어는 학습 교류 및 과학 연구와 같은 비상업적 목적으로만 사용됩니다. 이 소프트웨어를 상업적 목적으로 사용하는 것은 엄격히 금지됩니다. 상업적 활동이 발생하더라도 이 소프트웨어와는 무관합니다.",
    ),
    ...
    "externalControllerDesc": MessageLookupByLibrary.simpleMessage(
      "활성화되면 Clash 커널을 9090 포트에서 제어할 수 있습니다",
    ),
    "externalLink": MessageLookupByLibrary.simpleMessage("외부 링크"),
    "externalResources": MessageLookupByLibrary.simpleMessage(
      "외부 리소스",
    ),
    "fakeipFilter": MessageLookupByLibrary.simpleMessage("가짜 IP 필터"),
    "fakeipRange": MessageLookupByLibrary.simpleMessage("가짜 IP 범위"),
    ...
    "fileDesc": MessageLookupByLibrary.simpleMessage("프로필 직접 업로드"),
    ...
    "infiniteTime": MessageLookupByLibrary.simpleMessage("장기 유효"),
    ...
    "noIcon": MessageLookupByLibrary.simpleMessage("없음"),
    ...
    "nullLogsDesc": MessageLookupByLibrary.simpleMessage("로그 없음"),
    "nullProfileDesc": MessageLookupByLibrary.simpleMessage(
      "프로필 없음, 프로필을 추가하세요",
    ),
    "nullProxies": MessageLookupByLibrary.simpleMessage("프록시 없음"),
    "nullRequestsDesc": MessageLookupByLibrary.simpleMessage("요청 없음"),
    ...
    "resetTip": MessageLookupByLibrary.simpleMessage("초기화 확인"),
    ...
    "respectRulesDesc": MessageLookupByLibrary.simpleMessage(
      "DNS 연결이 규칙을 따르며, 프록시-서버-네임서버 설정 필요",
    ),
    "routeAddress": MessageLookupByLibrary.simpleMessage("경로 주소"),
    "routeAddressDesc": MessageLookupByLibrary.simpleMessage(
      "수신 경로 주소 설정",
    ),
    "routeMode": MessageLookupByLibrary.simpleMessage("경로 모드"),
    ...
    "tight": MessageLookupByLibrary.simpleMessage("조밀함"),
    ...
    "vpnEnableDesc": MessageLookupByLibrary.simpleMessage(
      "모든 시스템 트래픽을 VpnService를 통해 자동 라우팅",
    ),
    "vpnSystemProxyDesc": MessageLookupByLibrary.simpleMessage(
      "HTTP 프록시를 VpnService에 연결",
    ),
    "vpnTip": MessageLookupByLibrary.simpleMessage(
      "VPN을 재시작하면 변경 사항이 적용됩니다",
    ),
    ...
    "zh_CN": MessageLookupByLibrary.simpleMessage("간체 중국어"),
  };
}
