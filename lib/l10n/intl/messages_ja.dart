...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "dnsPreset": MessageLookupByLibrary.simpleMessage("DNSプリセット"),
    ...
    "appLock": MessageLookupByLibrary.simpleMessage("アプリロック"),
    "appLockEnabled": MessageLookupByLibrary.simpleMessage("アプリロックを有効にする"),
    "appLockEnabledDesc": MessageLookupByLibrary.simpleMessage("起動時またはバックグラウンドから復帰時にPINが必要です"),
    "setPIN": MessageLookupByLibrary.simpleMessage("PINを設定"),
    "changePIN": MessageLookupByLibrary.simpleMessage("PINを変更"),
    "enterCurrentPIN": MessageLookupByLibrary.simpleMessage("現在のPINを入力"),
    "enterNewPIN": MessageLookupByLibrary.simpleMessage("新しいPINを入力"),
    "confirmPIN": MessageLookupByLibrary.simpleMessage("PINを確認"),
    "pinMismatch": MessageLookupByLibrary.simpleMessage("PINが一致しません。再入力してください"),
    "pinTooShort": MessageLookupByLibrary.simpleMessage("PINは4桁以上必要です"),
    "pinSet": MessageLookupByLibrary.simpleMessage("PINが設定されました"),
    "pinIncorrect": MessageLookupByLibrary.simpleMessage("PINが正しくありません"),
    "autoLockTimeout": MessageLookupByLibrary.simpleMessage("自動ロック時間"),
    "neverLock": MessageLookupByLibrary.simpleMessage("なし"),
    "downloading": MessageLookupByLibrary.simpleMessage("ダウンロード中"),
    "downloadComplete": MessageLookupByLibrary.simpleMessage("ダウンロード完了、タップしてインストール"),
    "downloadFailed": MessageLookupByLibrary.simpleMessage("ダウンロード失敗、再試行してください"),
    "cancelDownload": MessageLookupByLibrary.simpleMessage("キャンセル"),
