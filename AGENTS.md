...
Panorama Secure Access is a multi-platform proxy client based on ClashMeta (mihomo), built with Flutter. Supports Android, Windows,
...
`Panorama-Secure-Access-2.0.15-macos-arm64.dmg`).
